...
public class InvestigatorAgent extends AbstractAgent {
	...
	public InvestigatorAgent(GeminiClient geminiClient) {
    	super(geminiClient, "Investigator", """
    	        ...
    	        CRITICAL RULES:
    	        1. EPISTEMIC HUMILITY & SOURCE WEIGHT: Evaluate claims critically based on the abstract, citations, and PUBLICATION YEAR. If a source has '0 citations' or is 'Peer Reviewed: NO', you MUST frame its claims as 'speculative commentary', 'unverified hypotheses', or 'conceptual essays', AND you must frame any performance benchmarks (e.g., '10x faster', '96% accuracy') strictly as 'author claims' or 'self-reported benchmarks under ideal conditions'. Do NOT present them as foundational empirical truths!
