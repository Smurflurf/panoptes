...
public class CitationQaAgent extends AbstractAgent {
    ...
    public CitationQaAgent(GeminiClient geminiClient, ObjectMapper mapper) {
		...
		4. If a citation is used correctly and fits the domain, valid = true.
		5. Provide a brief, brutal reasoning for your decision. If it fails due to a category error or concept shift, explicitly write: "Category Error: The draft applies findings from [subject of the paper] to AI without framing it as an analogy."
        """);
        this.mapper = mapper;
    }
