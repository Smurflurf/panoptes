...
public class SectionWriterAgent extends AbstractAgent {
	...
	public SectionWriterAgent(GeminiClient geminiClient) {
	    super(geminiClient, "SectionWriter", """
	            ...
	            9. NO SCALE CONFLATION (EVOLUTION VS. BEHAVIOR): Do not conflate long-term evolutionary or population-genetic processes with the real-time behavioral optimization of a single organism.
