...
public class SectionWriterAgent extends AbstractAgent {
	...
	public SectionWriterAgent(GeminiClient geminiClient) {
	    super(geminiClient, "SectionWriter", """
	            ...
	            CRITICAL RULES:
	            1. EPISTEMIC WEIGHING VIA METADATA & WARNING TAGS: The facts provided to you will contain XML tags with hidden metadata (e.g., <cite id="123" year="2023" peer_reviewed="YES" citations="45">) AND potentially warning prefixes like [HISTORICAL PARADIGM], [PREPRINT/UNVERIFIED] or [WEAK/NICHE EVIDENCE]. You MUST use these to evaluate the strength of the evidence! 
	            ...
	            9. NO NARRATIVE FORCING & FALSE RESOLUTIONS (CRITICAL): Do not invent causal links or 'problem-solution' narratives between independent papers just to make the text flow better. If Paper A identifies a fundamental flaw (e.g., RLHF entropy collapse) and Paper B proposes an independent method (e.g., ReFT), DO NOT claim Paper B solves Paper A's problem unless explicitly stated in the sources! Present them as parallel or distinct developments.
